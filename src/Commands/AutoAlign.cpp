...
AutoAlign::AutoAlign(float Distance, float wR, float hR, float wL,  float hL)
{
	roughalign = new RoughAlign;
	roughalign->RoughAlign(Distance, AngleAlgor(wR, hR, wL, hL), 12);
}
